import React, {useState, toggleMenuOpen, menuOpen} from 'react'
...
export function NavItem(props) {
    ...
    return (
        ...
        show={menuOpen} className={styles.navItem} title="Resources">
        {props.items}
        </NavDropdown>
    );
  };
...
export default function Footer({ menuItems }) {
  return (
    ...
    <Col className="d-none d-sm-none d-md-block d-lg-block">
        ...
        <NavItem items="randomLinks"></NavItem>
        <Container>
            ...
            <Nav className="me-auto">
                ...
                <NavDropdown onMouseEnter={() => {
                    ...
                    show={menuOpen} 
                    className={styles.navItem} title="Resources">
                    <NavDropdown.Item href="https://libportal.nus.edu.sg/frontend/e-resources" target="_self">E-Resource</NavDropdown.Item>
                    <NavDropdown.Item href="https://scholarbank.nus.edu.sg/" target="_blank">ScholarBank@NUS</NavDropdown.Item>
                    <NavDropdown.Item href="https://libportal.nus.edu.sg/frontend/web/resources/library-initiatives/digitized-collections" target="_self">Special Collections</NavDropdown.Item>
                    <NavDropdown.Item href="https://libportal.nus.edu.sg/frontend/recently-added-all-formats" target="_self">New Arrivals</NavDropdown.Item>
                    <NavDropdown.Item href="https://libportal.nus.edu.sg/frontend/web/resources/library-initiatives/our-publications" target="_self">Our Publications</NavDropdown.Item>
                </NavDropdown>
                ...
                <NavDropdown title="Contact &amp; Help">
